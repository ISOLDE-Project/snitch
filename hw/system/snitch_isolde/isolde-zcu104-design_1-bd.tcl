...
proc cr_bd_design_1 { parentCell } {
  ...
  ISOLDE-CAR:user:top_isolde_ip:1.0\
  "
...
\
    ...
    CONFIG.PSU__CRF_APB__DP_STC_REF_CTRL__ACT_FREQMHZ {26.470589} \
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {90.000000} \
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {90} \
...
\
  ...
  # Create instance: top_isolde_ip_0, and set properties
  set top_isolde_ip_0 [ create_bd_cell -type ip -vlnv ISOLDE-CAR:user:top_isolde_ip:1.0 top_isolde_ip_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net top_isolde_ip_0_m_axi_wide [get_bd_intf_pins top_isolde_ip_0/m_axi_wide] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]

  # Create port connections
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins top_isolde_ip_0/m_axi_wide_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins top_isolde_ip_0/m_axi_wide_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces top_isolde_ip_0/m_axi_wide] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces top_isolde_ip_0/m_axi_wide] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces top_isolde_ip_0/m_axi_wide] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"10,-504",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 3 -x 1150 -y -120 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 690 -y -240 -defaultsOSRD
preplace inst top_isolde_ip_0 -pg 1 -lvl 1 -x 220 -y -450 -defaultsOSRD
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 4 30 -370 NJ -370 NJ -370 1330
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 -330 420 -330 970
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 1 960 -250n
preplace netloc top_isolde_ip_0_m_axi_wide 1 1 1 410 -470n
levelinfo -pg 1 0 220 690 1150 1480 1640
pagesize -pg 1 -db -bbox -sgen -130 -530 1640 200
"
}
